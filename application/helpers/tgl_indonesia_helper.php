...
if (!function_exists('angka_huruf')) {
    function angka_huruf($angka)
    {
        ...
        if ($angka == "1") {
            ...
            $angka = "Dua Puluh Empat";
        } else if ($angka == "25") {
            $angka = "Dua Puluh Lima";
        } else if ($angka == "26") {
            $angka = "Dua Puluh Enam";
        } else if ($angka == "27") {
            $angka = "Dua Puluh Tujuh";
        } else if ($angka == "28") {
            $angka = "Dua Puluh Delapan";
        } else if ($angka == "29") {
            $angka = "Dua Puluh Sembilan";
        } else if ($angka == "30") {
            $angka = "Tiga Puluh";
        } else if ($angka == "31") {
            $angka = "Tiga Puluh Satu";
        } else if ($angka == "32") {
            $angka = "Tiga Puluh Dua";
        } else if ($angka == "33") {
            $angka = "Tiga Puluh Tiga";
        } else if ($angka == "34") {
            $angka = "Tiga Puluh Empat";
        } else if ($angka == "35") {
            $angka = "Tiga Puluh Lima";
        } else if ($angka == "36") {
            $angka = "Tiga Puluh Enam";
        } else if ($angka == "37") {
            $angka = "Tiga Puluh Tujuh";
        } else if ($angka == "38") {
            $angka = "Tiga Puluh Delapan";
        } else if ($angka == "39") {
            $angka = "Tiga Puluh Sembilan";
        } else if ($angka == "40") {
            $angka = "Empat Puluh";
        } else if ($angka == "41") {
            $angka = "Empat Puluh Satu";
        } else if ($angka == "42") {
            $angka = "Empat Puluh Dua";
        } else if ($angka == "43") {
            $angka = "Empat Puluh Tiga";
        } else if ($angka == "44") {
            $angka = "Empat Puluh Empat";
        } else if ($angka == "45") {
            $angka = "Empat Puluh Lima";
        } else if ($angka == "46") {
            $angka = "Empat Puluh Enam";
        } else if ($angka == "47") {
            $angka = "Empat Puluh Tujuh";
        } else if ($angka == "48") {
            $angka = "Empat Puluh Delapan";
        } else if ($angka == "49") {
            $angka = "Empat Puluh Sembilan";
        } else if ($angka == "50") {
            $angka = "Lima Puluh";
        }
        return $angka;
